...
Polimorfismo significa "muitas formas" ou seja uma função ou método que pode ser chamado de diferntes maneira 
ou possui diferentes comportamentos.
...
class Funcionario:
    ...
    # O decoratro property faz um método se comportar como um atributor
    # No caso abaixo essa é a maneira de se criar um "getter" em python
    @property
    def nome(self):
        return self._nome

    # O código abaico define um setter para o atributor _nome
    @nome.setter
