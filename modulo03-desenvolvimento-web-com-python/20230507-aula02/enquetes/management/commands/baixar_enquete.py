...
class Command(BaseCommand):
    ...
    # O métdo add_argumentos possibilita que definamos argumentos para o nosso comando.
    def add_arguments(self, parser):

        # Url -> nome do paramentro
        # nargs -> quantidae  de valores que esse parâmetro recebe
        # type -> é o tipo dos valores dos parâmetro
